...
import { Pill, AlertCircle, ArrowLeft } from "lucide-react";
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6 text-center">
        ...
        >
          ...
          <p className="text-violet-300/80">
            The path <span className="text-violet-200 font-mono px-1.5 py-0.5 bg-violet-900/50 rounded">{location.pathname}</span> does not exist in our systems.
          </p>

          <div className="h-px w-16 bg-violet-500/30 mx-auto my-6" />

          <p className="text-violet-300/70">
            Would you like to return to your health dashboard?
          </p>
        </motion.div>
